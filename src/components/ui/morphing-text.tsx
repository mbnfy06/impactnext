...
export const MorphingText = ({
    ...
    return (
        <div className={cn("relative inline-block", className)}>
            <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[var(--primary-yellow)] to-orange-500">
                {displayText}
                <span className="inline-block w-0.5 h-[0.9em] bg-gradient-to-b from-[var(--primary-yellow)] to-orange-500 animate-pulse ml-1 align-middle" />
            </span>
        </div>
    );
};
